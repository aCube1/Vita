...
typedef struct vt_gpu_shader_texture_desc {
...
} vt_gpu_shader_texture_desc;

typedef struct vt_gpu_shader_desc {
	const char *vs_src;
	const char *fs_src;
	vt_gpu_shader_texture_desc textures[VT_MAX_TEXTURE_UNIFORM_SLOTS];
} vt_gpu_shader_desc;
