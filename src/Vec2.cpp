...
[[nodiscard]] Vec2 Vec2::clamp(const Vec2& max, const Vec2& min) const {
	return Vec2 {
...
[[nodiscard]] Vec2 Vec2::clamp(f32 min, f32 max) const {
	return Vec2 {
...
[[nodiscard]] f32 Vec2::cross(const Vec2& other) const {
	vec2 a = { raw[0], raw[1] };
...
[[nodiscard]] f32 Vec2::distance_to(const Vec2& other) const {
	vec2 a = { raw[0], raw[1] };
	vec2 b = { other.raw[0], other.raw[1] };
...
[[nodiscard]] f32 Vec2::dot(const Vec2& other) const {
	vec2 a = { raw[0], raw[1] };
	vec2 b = { other.raw[0], other.raw[1] };
...
[[nodiscard]] f32 Vec2::lenght() const {
	return dot(*this);
}

[[nodiscard]] Vec2 Vec2::lerp(const Vec2& to, f32 weight) const {
...
[[nodiscard]] Vec2 Vec2::max(const Vec2& other) const {
	return Vec2 {
...
[[nodiscard]] Vec2 Vec2::max(f32 max) const {
	return Vec2 {
		std::max(raw[0], max),
		std::max(raw[1], max),
	};
...
[[nodiscard]] Vec2 Vec2::min(const Vec2& other) const {
	return Vec2 {
...
[[nodiscard]] Vec2 Vec2::min(f32 min) const {
	return Vec2 {
		std::min(raw[0], min),
		std::min(raw[1], min),
	};
